...
Or if it bothers you to put any of the grid in the model, it can be avoided altogether and just create the grid on the fly when needed,

in helpers/notes.rb,

  def create_grid( name )
    Grid.new( Note, :dom_id => name, :resizable => true )
  end
    
in views/notes/index.html.erb,
